...
INSERT INTO Event
 (name, start_date, end_date, total_duration, certification, categoryId, typeId) VALUES
 ('Python Club', '2019-02-18', NULL, 20,  0, 1, 11),
 ('Volunteers & Pizza', '2019-02-28', '2019-02-28', 2,  0, 1, 11),
 ('The Docker Programme: Eficode x The Shortcut', '2019-01-11', '2019-05-5', 20, 0, 1, 11),
 ('Marketers Open Space', '2019-01-18', '2019-05-22', 8, 0, 1, 11);

INSERT INTO Workshop_Event
 (eventId, workshopId) VALUES
 (104, 21),
 (104, 22);
 
insert into participants
(firstName, lastName, email, gender, age, countryId, background, employment_situation, career_satisfaction, attendance_rate, 
SIB_label, recommendation_done, newsletter_subscription, linkedIn_link)
values 
("Neha", "Khandelwal", "jbpneha@gmail.com", "Female", "25-34 years old", 2099, "Information technology", "Unemployed", 1, null, null, "No", "Yes", null),
("Basirul", "Islam", "rony.basir@yahoo.com", "Male", "25-34 years old", 2018, "Finance", "Studying", 1, null, null, "No", "Yes", null);

 
	
INSERT INTO Registration
 (attending_status, employment_status, career_satisfaction, expectation, workshopId, eventId, participantId) VALUES
 ('Attending', 'Unemployed', 1, 'Learning something new', 21, 101, 3001),
 ('Attending', 'Studying', 1, 'Improving current knowledge', 22, 101, 3002),
 ('Attending', 'Studying', 2, 'Improving current knowledge', 21, 102, 3001);